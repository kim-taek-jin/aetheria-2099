...
export const SCENES = {
  ...
  ENDING_JAYNE_ORIGIN: {
    ...
    beatBudget: 1,
    setting:
      '코어의 빛 속에서 리엔의 의식과 제인의 지워진 3년이 맞닿는다. 제인은 자신이 한때 섹터 9에서 리엔의 조수였고, 진실을 알아버려 기억을 지운 채 아래로 버려졌음을 깨닫는다.',
    setting:
      '제인이 잃어버렸던 수석 연구원 이름표를 가슴에 달고, 외부에서 불어오는 진짜 바람을 맞이한다. 코어의 빛 속에서 리엔의 의식과 지워졌던 3년이 맞닿는다.',
